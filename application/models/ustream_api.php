<?php
require("/Applications/XAMPP/xamppfiles/htdocs/POCs/Media/vendor/autoload.php");

#insert your Ustream credentials here
define("USER_NAME", "fady.fawzy19@hotmail.com");
define("PASSWORD", "Fady123");
#name of the video you want to upload, it has to be the same folder as the current script
define("VIDEO_NAME", "<VIDEOFILENAME.EXTENSION>");
...
function login($client) {
    $res = $client->request('POST', 'https://www.ustream.tv/oauth2/token', [
        'headers' => [
            ...
            'Authorization' => 'Basic ec638ec9882f9e663987fa961262675aaeeda01a'
        ],
        'form_params' => [
            #insert your client_id here
            'client_id' => '4406fb118c95c19fa6fec526c5ab8f36a691404d',
            'username' => USER_NAME,
            'password' => PASSWORD,
            'grant_type' => 'password',
...
function getChannelsDetails($client, $auth_token,$channelID) {
    $res = $client->request('GET', 'https://api.ustream.tv/channels/'.$channelID.'.json', [
        'headers' => [
            'Authorization' => 'Bearer ' . $auth_token
        ]
    ]);
