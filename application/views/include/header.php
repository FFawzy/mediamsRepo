    ...
    <body class="skin-blue">
        ...
        <header class="header">
            <a href="<?php echo base_url();?>" class="logo">
                ...
                MMS - <span style="font-size:10px;">Media Management System</span>
            </a>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <span><?php echo $this->session->userdata('user_data')['username']?> <i class="caret"></i></span>
                            </a>
                            <ul class="dropdown-menu">
                                <!-- User image -->
                                <li class="user-header bg-light-blue">
                                    <img src="<?php echo base_url();?>Assets/admin/img/avatar3.png" class="img-circle" alt="User Image" />
                                    <p>
                                        <?php echo $this->session->userdata('user_data')['username']?>
                                        <small><?php echo $this->session->userdata('user_data')['type']?></small>
                                    </p>
                                </li>
                ...
                <section class="sidebar">
                    ...
                    <div class="user-panel">
                        ...
                        <div class="pull-left info">
                            <p>Hello, <?php echo $this->session->userdata('user_data')['username']?></p>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="active">
                            <a href="<?php echo base_url();?>Dashboard/ustream">
                                <i class="fa fa-video-camera "></i> <span>Ustream</span>
                            </a>
                        </li>
